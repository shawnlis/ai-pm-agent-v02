    ...
    for item in items:
        lines.extend(
            [
                ...
                f"  - Current blocker: {item.current_blocker or 'none'}",
                f"  - Missing evidence: {', '.join(item.missing_evidence) or 'none'}",
                f"  - Exact missing evidence: {', '.join(item.exact_missing_evidence) or 'none'}",
                f"  - Required for THESIS_IMPROVING: {', '.join(item.required_for_THESIS_IMPROVING) or 'none'}",
                f"  - Required for CATALYST_MONITOR: {', '.join(item.required_for_CATALYST_MONITOR) or 'none'}",
                f"  - Required for OPPORTUNITY_REVIEW: {', '.join(item.required_for_OPPORTUNITY_REVIEW) or 'none'}",
                ...
                f"  - Red-team blocker: {item.red_team_blocker or 'none'}",
                f"  - Valuation required: {str(item.valuation_required).lower()}",
                f"  - Valuation gap: {item.valuation_gap or 'none'}",
                f"  - Portfolio context required but not used: {str(item.portfolio_context_required_but_not_used).lower()}",
                f"  - Portfolio gap not used: {item.portfolio_gap_not_used or 'none'}",
